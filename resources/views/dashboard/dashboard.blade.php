...
<style>
    ...
    body {
        font-size: 0.9rem; /* Slightly smaller base font for overall compactness */
    }

    /* Card padding and margin for general compactness */
    .card {
        margin-bottom: 0.75rem; /* Reduce card vertical spacing */
        border-radius: 0.25rem; /* Keep rounded corners */
    }
    .card-body {
        padding: 0.75rem; /* Slightly reduced default padding for card bodies */
    }
    ...
    .form-select-sm, .form-control-sm, .btn-sm {
        font-size: 0.7rem; /* Smaller form controls and buttons */
        padding: 0.2rem 0.4rem; /* More compact padding */
        height: 1.8rem; /* Set a fixed height for consistency */
    }
    .btn.btn-sm { /* Ensure generic btn-sm styles don't get overridden too much */
        font-size: 0.75rem;
    ...
    .kpi-card .card-body {
        padding: 0.6rem; /* Slightly increased for better visual balance */
        display: flex;
    ...
    .kpi-card h6.small {
        font-size: 0.75rem; /* Slightly larger title for readability */
        margin-bottom: 0.2rem; /* Reduced space below title */
        color: #6c757d; /* Muted color for titles */
        line-height: 1.2;
    }
    .kpi-value {
        font-size: 1.2rem; /* Larger, more prominent value */
        font-weight: 700;
        line-height: 1.2;
        margin-bottom: 0.2rem; /* Space below value */
        flex-grow: 1; /* Allow value to take up more vertical space if needed */
        display: flex; /* Use flex to center value if it's short */
        align-items: center; /* Center vertically within its flex area */
    }
    .kpi-trend-up,
    .kpi-trend-down,
    .kpi-trend-neutral {
        font-size: 0.65rem; /* Slightly increased trend font size */
        line-height: 1;
        display: block;
        margin-top: auto; /* Pushes to the bottom of the card body */
        text-align: right; /* Align trend to the right */
        font-weight: 600; /* Make trend bold */
    }
    .kpi-trend-up {
        color: #28a745;
    }
    ...
    /* --- Tab Navigation --- */
    .nav-tabs .nav-link {
        font-size: 0.75rem; /* Smaller tabs */
    ...
    .compact-table th, .compact-table td {
        font-size: 0.7rem; /* Make table content smaller */
        padding: 0.4rem; /* Reduce cell padding */
        vertical-align: middle; /* Ensure content is vertically aligned */
    }

    .badge {
        font-size: 0.65rem; /* Slightly larger badges for readability */
        padding: 0.25rem 0.5rem;
    }
    .no-data-message {
        font-size: 0.75rem; /* Smaller no data message */
        color: #6c757d;
        text-align: center;
        padding: 0.75rem;
    }
    ...
    @media (max-width: 576px) {
        ...
        .container-fluid {
            padding-left: 0.25rem; /* Reduce overall padding on edges */
            padding-right: 0.25rem;
        }
        .col-6 { /* This is already set, ensuring 2 columns for KPIs */
            flex: 0 0 50%;
            max-width: 50%;
        }
        .header-title {
            font-size: 0.8rem; /* Smaller header titles */
            margin-bottom: 0.5rem;
        }
        .form-select-sm, .form-control-sm, .btn-sm {
            font-size: 0.6rem; /* Even smaller form controls and buttons */
            padding: 0.15rem 0.3rem;
            height: 1.5rem; /* Consistent smaller height */
        }
        .kpi-card .card-body {
            padding: 0.3rem; /* Even tighter padding for KPI cards */
        }
        .kpi-card h6.small {
            font-size: 0.65rem; /* Smallest title size */
        }
        .kpi-value {
            font-size: 0.9rem; /* Smallest KPI value size */
        }
        .kpi-trend-up, .kpi-trend-down, .kpi-trend-neutral {
            font-size: 0.55rem; /* Smallest trend text */
        }
        .tat-table th, .tat-table td,
        .compact-table th, .compact-table td {
            font-size: 0.6rem; /* Smallest table content */
            padding: 0.2rem; /* Minimal padding */
        }
        .badge {
            font-size: 0.55rem; /* Smallest badges */
            padding: 0.15rem 0.3rem;
        }
        .loader-overlay .spinner-border {
            width: 1.8rem; /* Smaller spinner on mobile */
            height: 1.8rem;
        }
    }
    /* Larger tablets and horizontal phones */
    @media (min-width: 577px) and (max-width: 768px) {
        .col-sm-4 { /* Ensure 3 columns for KPIs on small tablets */
            flex: 0 0 33.333333%;
            max-width: 33.333333%;
        }
        .kpi-card .card-body {
