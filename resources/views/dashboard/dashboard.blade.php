                                ...
                                <tbody>
                                    ...
                                    <tr class="status-card {{ $application->status }}">
                                        ...
                                        <td class="action-btns">
                                            @php
                                            $userHasActed = $application->approvalLogs->contains('user_id', Auth::id());
                                            $isCurrentApprover = $application->current_approver_id == Auth::id();
                                            @endphp

                                            @if($isCurrentApprover && !$userHasActed)
                                            <a href="{{ route('approvals.show', $application) }}" class="btn btn-sm btn-primary">
                                                <i class="fas fa-eye"></i> Review
                                            </a>
                                            @elseif($userHasActed)
                                            @php
                                            $userAction = $application->approvalLogs
