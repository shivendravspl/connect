...
@section('content')
    ...
    <div class="form-group">
        <label for="purpose_of_transaction_with_company" class="form-label">Purpose Of Transaction with company </label>
        <input type="text" class="form-control  " 
               id="purpose_of_transaction_with_company" name="purpose_of_transaction_with_company" 
               placeholder="Purpose Of Transaction with company"   
