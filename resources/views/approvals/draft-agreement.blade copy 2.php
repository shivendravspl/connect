...
/* =========================
   STAMP SPACE (FIRST PAGE ONLY)
========================= */
.stamp-space {
    display: none;
    height: 100mm;   /* Exact stamp space */
}
...
.stamp-mode .page:first-child .page-content {
    padding-top: 15mm; /* Reduced padding when stamp exists */
}
...
<!-- =======================
   ACTION BUTTONS
======================= -->
<div class="no-print position-fixed top-0 end-0 p-3 bg-white shadow">
    <div class="mb-2">
        <input type="radio" name="printMode" value="e" checked> Without Stamp<br>
        <input type="radio" name="printMode" value="s"> With Stamp
    </div>
    <button onclick="window.print()" class="btn btn-sm btn-primary w-100">Print</button>
</div>
...
<div class="agreement-container" id="doc">
    ...
    <div class="page">
        ...
        <!-- Stamp space (only one, only here) -->
            ...
            <div class="page-content">
                <div class="agreement-content">
                    ...
                    <ol>
                        ...
                        <li><strong>Responsibility Upon Pickup:</strong> If approved, the entire responsibility for the products shall transfer to the Authorized Distributor upon collection, in such case no claims </li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="page-content">
                <div class="agreement-content">
                    <div style="margin-left: 1.27cm;">
                        and liability other than the transport or delivery costs shall be entertained by the Company.
                    </div>
        ...
        <div class="page">
            <div class="page-content">
                <div class="agreement-content">
                    <div style="margin-left: 1.27cm;">an event, the Company reserves the right to immediately terminate the appointment of the Authorized Distributor without prior notice. Furthermore, the Company may initiate appropriate legal proceedings and impose penalties or recovery charges at its discretion.</div>
                    ...
                    <div class="numbered-clause">9. Appointment of Sub Distributors and Indemnification</div>
                        ...
                        <ol>
                            ...
                            <div>- Any act, deed, misfeasance, or negligence of the Sub Distributor, its servants, agents, or contracted parties.</div>
                            <div>- Breach of any terms or conditions of this Agreement, including failure to comply with the Distributor's directions or instructions related to the products sold by the Company.</div>
                            </li>
                    ...
                    <div class="numbered-clause">10. Cheque Issuance and Authorization</div>
                      <ol>
                        <li>The Authorized Distributor acknowledges and agrees that, in compliance with its payment obligations under this Agreement, it has issued the following cheques in favor of the Company to settle outstanding dues arising from its transactions with the</li>        
                      </ol>
            </div>
        </div>
        ...
        <div class="page">
            <div class="page-content">
                <div class="agreement-content">
                   Company. The Authorized Distributor further agrees to promptly issue replacement cheques and furnish the updated banking information in the event of any changes of its bank account details, or upon request by the Company.
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('input[name="printMode"]').forEach(radio => {
        radio.addEventListener('change', function () {
            container.classList.toggle('stamp-mode', this.value === 's');
        });
    });
});
</script>
