...
@section('title', 'Pending Documents Report')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0" style="font-size: 16px;">Pending Documents Report</h4>
            </div>
        </div>
    </div>
                ...
                <div class="card-body p-3">
                    ...
                    <form method="GET" class="row g-2 align-items-center mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('pending-documents') }}" class="btn btn-secondary btn-sm">
                                <i class="ri-refresh-line me-1"></i> Reset
                            </a>
                            <a href="{{ route('pending-documents', array_merge(request()->all(), ['export' => 'excel'])) }}" 
                        ...
                        <table class="table table-bordered table-striped table-sm mb-2">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size: 11px; padding: 6px;">Current Progress Step</th>
                                    <th style="font-size: 11px; padding: 6px;">Document Status</th>
                                    <th style="font-size: 11px; padding: 6px;">Created By</th>
                                    <th style="font-size: 11px; padding: 6px;">Created At</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 6px;">{{ $distributor->current_progress_step ?? 'N/A' }}</td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="7" class="text-center py-2" style="font-size: 12px;">No pending documents found</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
