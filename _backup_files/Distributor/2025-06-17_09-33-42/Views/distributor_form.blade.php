...
@endpush
@section('content')
    <div class="form-container content-width-full distributor-form-content js-ak-delete-container">
        <form method="POST" action="@isset($data->id){{route("distributor.update", $data->id)}}@else{{route("distributor.store")}}@endisset" enctype="multipart/form-data" class="form-page validate-form" novalidate>
            <div hidden>
             ...
             <div class="form-header">
                ...
                <div class="form-delete-record">
                    @if(isset($data->id))
                        <a href="#" data-link="{{route('distributor.destroy',$data->id)}}" data-id="{{$data->id}}" class="delete-link js-ak-delete-link" draggable="false">
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                ...
                <div class="error-message @if ($errors->has('name')) show @endif">
                    Required!</div>
                <div class="text-muted" id="name_help">
            ...
            @includeIf("layouts.form_footer",["cancel_route"=>route("distributor.index")])
        </form>
