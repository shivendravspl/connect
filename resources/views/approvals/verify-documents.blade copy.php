...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.view-main-document').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            // Set iframe source and reset zoom
    ...
    document.querySelectorAll('.view-additional-document').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            // Get index from modal ID or use docId
    ...
    document.querySelectorAll('.modal').forEach(modalElement => {
        modalElement.addEventListener('hidden.bs.modal', function() {
            // Remove iframe content to prevent conflicts
...
document.getElementById('verifyForm').addEventListener('submit', function(e) {
    ...
    const notVerifiedRadios = document.querySelectorAll('input[name^="document_verifications"]:checked[value="not_verified"]');
    const hasNotVerifiedDocs = notVerifiedRadios.length > 0;
    const additionalNameInputs = document.querySelectorAll('input[name$="[name]"]');
    ...
    if (hasNotVerifiedDocs && !confirm('Some documents are marked as "Not Verified". This will send the application back for corrections. Do you want to continue?')) {
        return;
    }
    ...
    // Input validation for additional documents
