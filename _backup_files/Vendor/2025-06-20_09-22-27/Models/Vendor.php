...
class Vendor extends Model
{
    ...
    protected $fillable = ['email', 'company_name', 'nauture_of_business', 'purpose_of_transaction_with_company', 'companys_address', 'pincode', 'vendor_email_id', 'contact_person_name', 'contact_no', 'contact_person_name', 'payment_terms'];
