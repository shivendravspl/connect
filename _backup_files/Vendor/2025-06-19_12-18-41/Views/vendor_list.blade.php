                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('vendor.edit', 1) }}" class="btn btn-sm btn-outline-primary me-1">
                                        <i class="ri-edit-line"></i>
                                    </a>
                                    <a href="javascript:void(0)" data-link="{{ route('vendor.destroy', 1) }}" class="btn btn-sm btn-outline-danger js-ak-delete-link">
                            ...
                            <tr>
                                <td>2</td>
                                <td class="text-center">
                                    <a href="{{ route('vendor.edit', 2) }}" class="btn btn-sm btn-outline-primary me-1">
                                        <i class="ri-edit-line"></i>
                                    </a>
                                    <a href="javascript:void(0)" data-link="{{ route('vendor.destroy', 2) }}" class="btn btn-sm btn-outline-danger js-ak-delete-link">
                                        <i class="ri-delete-bin-line"></i>
                                    </a>
                                </td>
                            </tr>
