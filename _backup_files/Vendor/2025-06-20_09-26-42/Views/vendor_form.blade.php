...
@section('content')
    ...
    <div class="form-group">
        ...
        <div class="form-check"><input class="form-check-input" type="radio" name="gender" id="gender_1" value="1" required><label class="form-check-label" for="gender_1">Option 1</label></div><div class="form-check"><input class="form-check-input" type="radio" name="gender" id="gender_2" value="2" required><label class="form-check-label" for="gender_2">Option 2</label></div>
