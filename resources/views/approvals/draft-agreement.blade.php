...
<head>
    ...
    /* Each page has consistent margins */
    .page-content {
        padding: 25mm 25mm 20mm 25mm; /* Standard Word margins */
        min-height: 252mm; /* 297mm - (25mm top + 20mm bottom) */
        box-sizing: border-box;
        position: relative;
    }
    
    /* Force page break after each page except last */
    .page {
        page-break-after: always;
        position: relative;
        border-bottom: 1px solid #eee;
        margin-bottom: 5mm; /* Space between pages on screen */
    }
    ...
    .agreement-content {
        font-size: 12pt; /* Word default is 12pt */
        line-height: 1.25; /* Single line spacing in Word */
        text-align: justify;
        font-family: 'Times New Roman', Times, serif;
    }
    ...
    .agreement-header h2 {
        font-size: 16pt; /* Slightly larger for title */
        font-weight: bold;
    ...
    .agreement-content p {
        margin-bottom: 12pt; /* Single line spacing (12pt font = 12pt spacing) */
        text-indent: 1.27cm; /* 0.5 inch indent for all paragraphs */
        orphans: 2;
        widows: 2;
        font-family: 'Times New Roman', Times, serif;
    }
    ...
    .agreement-content > p:first-of-type {
    ...
    /* Special class for centered "AND" */
    .centered-and {
    ...
    .agreement-content h5 {
        font-size: 12pt;
        font-weight: bold;
        margin-top: 18pt; /* 1.5 lines */
        margin-bottom: 12pt; /* 1 line */
        text-indent: 0;
        page-break-after: avoid;
        font-family: 'Times New Roman', Times, serif;
    }
    ...
    .agreement-content h6 {
        font-size: 12pt;
        font-weight: bold;
        margin-top: 12pt; /* 1 line */
        margin-bottom: 6pt; /* 0.5 line */
        text-indent: 0;
        page-break-after: avoid;
        font-family: 'Times New Roman', Times, serif;
    }
    ...
    .agreement-content ul {
        margin: 12pt 0;
        padding-left: 1.27cm; /* 0.5 inch indent */
        text-indent: 0;
    }
    ...
    table.blank-table {
        ...
        font-size: 11pt; /* Slightly smaller font for tables */
        font-family: 'Times New Roman', Times, serif;
    }
    ...
    /* Stamp space for first page - only in stamp mode */
    .stamp-space {
        display: none;
        height: 100mm;
        width: 100%;
    ...
    /* Stamp mode - show stamp space on first page */
    .stamp-mode .page:first-child .stamp-space {
        display: block;
    }
    
    /* In stamp mode, reduce content height on first page */
    .stamp-mode .page:first-child .page-content {
        padding-top: 0; /* No top padding since stamp space is above */
    }
    ...
    /* Page number indicator for screen */
    .page-number {
        position: absolute;
        bottom: 10px;
        right: 25mm;
    ...
    @media print {
        ...
        .stamp-space .stamp-text {
            display: none !important; /* Hide text in print */
        }
        
        /* Adjust first page content when stamp space is present */
        .stamp-mode .page:first-child .page-content {
        ...
        @page {
            size: A4;
            margin: 0; /* We control margins in .page-content */
        }
...
<div class="page">
    <div class="stamp-space">
        <div class="stamp-text">
            Space for Physical Stamp Paper<br>
            <small>(Print on stamp paper; content starts below)</small>
        </div>
    </div>
    <div class="page-content">
        ...
        <div class="agreement-content">
            ...
            <p class="centered-and"><strong>AND</strong></p>
            
            
            <p><strong>{{ $establishmentName ?? '__________________________________' }}</strong>, Distributor Name: <strong>{{ $contactPersonName ?? '__________________________________' }}</strong>, having its Company place of business at: <strong>{{ $formattedAddress ?? '________________________________________________________________' }}</strong>, a <strong>{{ $entityType ?? '________________' }}</strong> (hereinafter referred to as <strong>the "Second Party"</strong>, which expression shall, unless repugnant to the context or meaning thereof, mean and include its affiliates, successors and permitted assigns) of Other Part.</p>
        </div>
            ...
            <div class="page-content">
                <div class="agreement-content">
                    ...
                    <ol>
                        ...
                        <li><strong>Responsibility Upon Pickup:</strong> If approved, the entire responsibility for the products shall transfer to the Authorized Distributor upon collection, in such case no claims and</li>
                    </ol>
                </div>
        ...
        <div class="page">
            <div class="page-content">
                <div class="agreement-content">
                    <p style="text-indent: 0; margin-top: 0;">and liability other than the transport or delivery costs shall be entertained by the Company.</p>
        ...
        <div class="page">
            <div class="page-content">
                <div class="agreement-content">
                    <p style="text-indent: 0; margin-top: 0;">an event, the Company reserves the right to immediately terminate the appointment of the Authorized Distributor without prior notice. Furthermore, the Company may initiate appropriate legal proceedings and impose penalties or recovery charges at its discretion.</p>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            radios.forEach(radio => {
                radio.addEventListener('change', function() {
                    ...
                    container.classList.remove('stamp-mode', 'e-stamp-mode');
                    
                    if (this.value === 'stamp') {
                        container.classList.add('stamp-mode');
                    } else {
                        container.classList.add('e-stamp-mode');
                    }
                });
            });

            // Set initial mode
            document.getElementById('e-stamp').checked = true;
            container.classList.add('e-stamp-mode');
        });
    </script>
</body>
