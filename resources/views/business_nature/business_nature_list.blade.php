                ...
                <div class="d-flex align-items-center">
                    <form class="d-flex me-3" role="search">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="business_nature_search" placeholder="Search" value="{{ Request()->query('business_nature_source') == 'business_nature' ? Request()->query('business_nature_search') ?? '' : '' }}" autocomplete="off">
                    ...
                    @can('add-BusinessNature')
                        <a href="{{ route('business_nature.create') }}" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @can('edit-BusinessNature')
                                            <a href="{{ route('business_nature.edit', $data->id) }}" class="btn btn-sm btn-outline-primary me-1">
                                                <i class="ri-edit-line"></i>
                                            </a>
                                        @endcan
                                        @can('delete-BusinessNature')
                                            <a href="javascript:void(0)" data-link="{{ route('business_nature.destroy', $data->id) }}" class="btn btn-sm btn-outline-danger js-ak-delete-link">
