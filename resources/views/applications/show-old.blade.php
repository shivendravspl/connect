...
<div class="container mt-3">
    ...
    <div id="entity-details" class="card mb-3">
        ...
        <div class="card-body p-2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="document-link">
                                @if($doc['path'])
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#documentModal{{ $index }}"><i class="ri-eye-line"></i></button>
                                @else
                                N/A
                                @endif
                            </td>
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h6 class="mb-1">Proprietor Details</h6>
                </div>
                <div class="card-body p-2">
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm">
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h6 class="mb-1">{{ ucfirst(str_replace('_', ' ', $application->entityDetails->entity_type)) }} Details</h6>
                </div>
                <div class="card-body p-2">
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm">
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h6 class="mb-1">{{ $application->entityDetails->entity_type === 'partnership' ? 'Partners' : ($application->entityDetails->entity_type === 'llp' ? 'Designated Partners' : ($application->entityDetails->entity_type === 'cooperative_society' ? 'Committee Members' : ($application->entityDetails->entity_type === 'trust' ? 'Trustees' : 'Directors'))) }}</h6>
                </div>
                <div class="card-body p-2">
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-2">
                            <iframe src="{{ Storage::disk('s3')->url('Connect/Distributor/' . $doc['type'] . '/' . $doc['path']) }}" title="{{ $doc['type'] ?? 'Document' }}"></iframe>
                        </div>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <h6 class="mb-1">Authorized Persons</h6>
        </div>
        <div class="card-body p-2">
            <div class="table-responsive">
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#authLetterModal{{ $index }}"><i class="ri-eye-line"></i></button>
                                @else
                                N/A
                                @endif
                            </td>
                            <td>
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#authAadharModal{{ $index }}"><i class="ri-eye-line"></i></button>
                                @else
                                N/A
                                @endif
                            </td>
    ...
    <div class="modal fade" id="authLetterModal{{ $index }}" tabindex="-1" aria-labelledby="authLetterModalLabel{{ $index }}" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-2">
                    <iframe src="{{ Storage::disk('s3')->url('Connect/Distributor/authorized_persons/' . $person['letter']['path']) }}" title="Authorization Letter"></iframe>
                </div>
                <div class="modal-footer p-2">
    ...
    <div class="modal fade" id="authAadharModal{{ $index }}" tabindex="-1" aria-labelledby="authAadharModalLabel{{ $index }}" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-2">
                    <iframe src="{{ Storage::disk('s3')->url('Connect/Distributor/authorized_persons/' . $person['aadhar']['path']) }}" title="Aadhar Document"></iframe>
                </div>
                <div class="modal-footer p-2">
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                </div>
