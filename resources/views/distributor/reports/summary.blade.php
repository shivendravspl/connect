                    ...
                    <form method="GET" class="mb-2">
                        ...
                        <div class="row g-1 align-items-end">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="bu" class="form-select form-select-sm" id="bu">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="zone" class="form-select form-select-sm" id="zone">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="region" class="form-select form-select-sm" id="region">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="territory" class="form-select form-select-sm" id="territory">
                        ...
                        <table class="table table-bordered table-striped table-sm mb-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if($reportType == 'approval')
                                        <td>{{ $distributor->current_approver_name ?? 'N/A' }}</td>
...
/* Center align Select2 dropdown text */
