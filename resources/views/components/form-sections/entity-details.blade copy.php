...
<div class="row g-2">
    ...
    <div class="col-12 col-md-6">
        ...
        <input type="text" class="form-control form-control-sm" id="pan_number" name="pan_number" value="{{ old('pan_number', $panDoc['details']['pan_number'] ?? ($application->entityDetails->pan_number ?? '')) }}" pattern="[A-Z]{5}[0-9]{4}[A-Z]" maxlength="10" required>
...
<div id="gst_fields" style="display: {{ old('gst_applicable', ($application->entityDetails->gst_applicable ?? ($gstDoc ? 'yes' : 'no'))) === 'yes' ? 'block' : 'none' }};">
        ...
        <div class="col-12">
            <div class="form-group mb-2">
                ...
                <div id="gst_file_name" class="small text-muted mb-2 {{ $gstDoc ? '' : 'd-none' }}">
                    @if($gstDoc)
                        <a href="#" data-bs-toggle="modal" data-bs-target="#documentModal" data-src="{{ asset('storage/' . $gstDoc['path']) }}">View GST Document</a> 
                        (Uploaded on {{ $gstDoc['remarks'] }})
    ...
    <!-- GST Number + GST Validity in single row -->
    <div class="row g-2">
        <div class="col-md-6">
            <div class="form-group mb-2">
        ...
        <div class="col-12 col-md-3">
            <div class="form-group mb-2">
                ...
                <input type="text" class="form-control form-control-sm" id="account_number" name="account_number"
                    value="{{ old('account_number', $bankDoc['details']['account_number'] ?? ($application->entityDetails->additional_data['bank_details']['account_number'] ?? '')) }}" inputmode="numeric" required>
            </div>
        </div>
        <div class="col-12 col-md-3">
            <div class="form-group mb-2">
